...
const Events = () => {
    ...
    query {
      sundayBands: allGraphCmsBand(filter: {timeSlots: {elemMatch: {scheduledDay: {eq: Sunday }}}}) {
        nodes {
          name
            image {
      ...
      mondayBands: allGraphCmsBand(filter: {timeSlots: {elemMatch: {scheduledDay: {eq: Monday }}}}) {
        nodes {
          name
            image {
              gatsbyImageData(quality:100)
      ...
      tuesdayBands: allGraphCmsBand(filter: {timeSlots: {elemMatch: {scheduledDay: {eq: Tuesday }}}}) {
        nodes {
          name
            image {
              gatsbyImageData(quality:100)
      ...
      wednesdayBands: allGraphCmsBand(filter: {timeSlots: {elemMatch: {scheduledDay: {eq: Wednesday }}}}) {
        nodes {
          name
            image {
              gatsbyImageData(quality:100)
      ...
      thursdayBands: allGraphCmsBand(filter: {timeSlots: {elemMatch: {scheduledDay: {eq: Thursday }}}}) {
        nodes {
          name
            image {
              gatsbyImageData(quality:100)
      ...
      fridayBands: allGraphCmsBand(filter: {timeSlots: {elemMatch: {scheduledDay: {eq: Friday }}}}) {
        nodes {
          name
            image {
              gatsbyImageData(quality:100)
      ...
      saturdayBands: allGraphCmsBand(filter: {timeSlots: {elemMatch: {scheduledDay: {eq: Saturday }}}}) {
        nodes {
          name
            image {
              gatsbyImageData(quality:100)
...
`);
    ...
    return (
      <div className="pt-2">
        ...
        <div className="absolute w-full overflow-auto" style={{top: eventsWrapperTop, height: eventsWrapperHeight}}>
          ...
          <>
            ...
            <div className="flex flex-col items-center w-full">
                ...
                <div className="flex flex-row items-center w-full mx-2 p-2">
                    <button 
                        className={`rounded-full w-10 h-10 mx-auto ${daySelected === 0 ? 'bg-red-600 text-white' : 'bg-white text-red-600'}`}
                        onClick={() => setDaySelected(0)}
                    >
                        <h2 className="text-xl">S</h2>
                    </button>
                    <button 
                        className={`rounded-full w-10 h-10 mx-auto ${daySelected === 1 ? 'bg-red-600 text-white' : 'bg-white text-red-600'}`}
                        onClick={() => setDaySelected(1)}
                    >
                        <h2 className="text-xl">M</h2>
                    </button>
                    <button 
                        className={`rounded-full w-10 h-10 mx-auto ${daySelected === 2 ? 'bg-red-600 text-white' : 'bg-white text-red-600'}`}
                        onClick={() => setDaySelected(2)}
                    >
                        <h2 className="text-xl">T</h2>
                    </button>
                    <button 
                        className={`rounded-full w-10 h-10 mx-auto ${daySelected === 3 ? 'bg-red-600 text-white' : 'bg-white text-red-600'}`}
                        onClick={() => setDaySelected(3)}
                    >
                        <h2 className="text-xl">W</h2>
                    </button>
                    <button 
                        className={`rounded-full w-10 h-10 mx-auto ${daySelected === 4 ? 'bg-red-600 text-white' : 'bg-white text-red-600'}`}
                        onClick={() => setDaySelected(4)}
                    >
                        <h2 className="text-xl">T</h2>
                    </button>
                    <button 
                        className={`rounded-full w-10 h-10 mx-auto ${daySelected === 5 ? 'bg-red-600 text-white' : 'bg-white text-red-600'}`}
                        onClick={() => setDaySelected(5)}
                    >
                        <h2 className="text-xl">F</h2>
                    </button>
                    <button 
                        className={`rounded-full w-10 h-10 mx-auto ${daySelected === 6 ? 'bg-red-600 text-white' : 'bg-white text-red-600'}`}
                ...
                <div className="flex flex-col">
                            ...
                            return(
                                <div className="flex flex-col py-2">
                                    ...
                                    <div className="flex flex-row items-center">
                                        ...
                                        <h2 className="text-xl leading-none">{scheduledTime}</h2>
                                    </div>
                                </div>           
                            )
                        })}
                    ...
                    : null}
                    <p className="py-2">For the most recent updates, be sure to check our <a className="cursor-pointer" href="https://www.facebook.com">Facebook</a> page.</p>
                </div>
            </div>
